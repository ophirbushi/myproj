...
import { getHotelSize, getHotelsInvolvedInMerge } from './tiles'
...
export const getHotelName = (state: State, hotelIndex: number): string => {
  return state.config.hotels[hotelIndex].hotelName
}
